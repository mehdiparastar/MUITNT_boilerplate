...
l36="\t\timage: mysql\n"
l37="\t\tenvironment:\n"
l38="\t\t\t- MYSQL_ROOT_PASSWORD=password\n"
...
l57="\n"
l58="networks:\n"
l59="\tmuitnt-stack-net-dev:\n"
l60="\t\tdriver: bridge\n"
l61=""
l62=""
docker_compose="${l01}${l02}${l03}${l04}${l05}${l06}${l07}${l08}${l09}${l10}${l11}${l12}${l13}${l14}${l15}${l16}${l17}${l18}${l19}${l20}${l21}${l22}${l23}${l24}${l25}${l26}${l27}${l27_1}${l27_2}${l28}${l29}${l30}${l31}${l32}${l33}${l34}${l35}${l36}${l37}${l38}${l39}${l40}${l41}${l42}${l43}${l44}${l45}${l46}${l47}${l48}${l49}${l50}${l51}${l52}${l53}${l54}${l55}${l56}${l57}${l58}${l59}${l60}${l61}${l62}"
