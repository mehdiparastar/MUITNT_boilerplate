...
import { Accordion, AccordionDetails, AccordionSummary, Button, Card, CardActionArea, CardActions, CardContent, CardHeader, Checkbox, Chip, Divider, FormControlLabel, FormGroup, Grow, IconButton, Pagination, Paper, Radio, Skeleton, Slide, Tooltip, Typography } from '@mui/material';
...
const PermissionRequest: React.FunctionComponent<IPermissionRequestProps> = (props) => {
    ...
    return (
        <Grid container>
            ...
            {(count === 0) &&
                <Grid xs={12}>
                    <Item data-aos="flip-left" justifyContent={'center'} display="flex" m={1}>
