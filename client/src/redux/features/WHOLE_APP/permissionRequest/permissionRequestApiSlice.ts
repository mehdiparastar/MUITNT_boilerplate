...
export const permissionRequestApiSlice = apiSlice.injectEndpoints({
    endpoints: (builder) => ({
        createPermissionRequest: builder.mutation<IPermissionRequest, { role: string }>({
            query(PR) {
                return {
        ...
        getMyAllPermissionRequest: builder.query<IPermissionRequestPaginated, { query: string }>({
            query({ query }) {
                return {
            ...
            transformResponse: (results: { data: IPermissionRequest[], count: number }) => {
                return ({
                    ...results,
        ...
        getAllPermissionRequestToApprove: builder.query<IPermissionRequestPaginated, { query: string }>({
            query({ query }) {
                return {
        ...
        deletePermissionRequest: builder.mutation<IPermissionRequest, { id: number }>({
            query({ id }) {
                return {
        ...
        setPermissionRequestToSEEN: builder.mutation<IPermissionRequest, { pReqId: number }>({
            query({ pReqId }) {
                return {
        ...
        setPermissionRequestToAPPROVE: builder.mutation<IPermissionRequest, { pReqId: number }>({
            query({ pReqId }) {
                return {
        ...
        setPermissionRequestToREJECT: builder.mutation<IPermissionRequest, { pReqId: number }>({
            query({ pReqId }) {
                return {
